...
public class ParkGetAction extends AbstractAction {

	private static final Logger LOG = Logger.getLogger(ParkGetAction.class);
	...
	private static final String JSP_DESCRIPTION_GET = "jsp.park.get";

	private RegexValidator idValidator;

	public ParkGetAction() {
